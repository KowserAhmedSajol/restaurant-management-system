...
<html dir="ltr" lang="en">
  <head>
    ...
    type="image/png"
    sizes="16x16"
    href="{{ asset('theme/assets/images/favicon.png') }}"
  />
  <!-- Custom CSS -->
  <link
    href="{{ asset('theme/assets/libs/jquery-steps/jquery.steps.css') }}"
    rel="stylesheet"
  />
  <link
    href="{{ asset('theme/assets/libs/jquery-steps/steps.css') }}"
    rel="stylesheet"
  />
  <link
    href="{{ asset('theme/dist/css/style.min.css') }}"
    rel="stylesheet"
  />
  ...
  <body>
          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                src="{{ asset('theme/assets/images/logo-icon.png') }}"
                alt="homepage"
                class="light-logo"
                width="25"
              />
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                src="{{ asset('theme/assets/images/logo-text.png') }}"
                alt="homepage"
                class="light-logo"
              />
          ...
          >
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                ...
                >
                <img
                src="{{ asset('theme/assets/images/users/1.jpg') }}"
                alt="user"
    ...
    <!-- this page js -->
    <script src="{{ asset('theme/assets/libs/jquery-steps/build/jquery.steps.min.js') }}"></script>
    <script src="{{ asset('theme/assets/libs/jquery-validation/dist/jquery.validate.min.js') }}"></script>
